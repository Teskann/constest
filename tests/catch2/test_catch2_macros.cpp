...
TEST_CASE("CONSTEXPR_REQUIRE should be called at runtime", "[macros]")
{
...
TEST_CASE("CONSTEXPR_REQUIRE should be evaluated once only", "[macros]")
{
    test_call_at_runtime::reset();
...
TEST_CASE("CONSTEXPR_REQUIRE_FALSE should be called at runtime", "[macros]")
{
    test_call_at_runtime::reset();
...
TEST_CASE("CONSTEXPR_REQUIRE_FALSE should be evaluated once only", "[macros]")
{
    test_call_at_runtime::reset();
...
TEST_CASE("CONSTEXPR_CHECK should be called at runtime", "[macros]")
{
    test_call_at_runtime::reset();
...
TEST_CASE("CONSTEXPR_CHECK should be evaluated once only", "[macros]")
{
    test_call_at_runtime::reset();
...
TEST_CASE("CONSTEXPR_CHECK_FALSE should be called at runtime", "[macros]")
{
    test_call_at_runtime::reset();
...
TEST_CASE("CONSTEXPR_CHECK_FALSE should be evaluated once only", "[macros]")
{
    test_call_at_runtime::reset();
...
TEST_CASE("CONSTEXPR_SECTION_DEBUG should work with all macros", "[macros]")
{
